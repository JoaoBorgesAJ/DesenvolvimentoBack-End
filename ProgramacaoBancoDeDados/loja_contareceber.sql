...
CREATE TABLE `contareceber` (
  ...
  CONSTRAINT `contareceber_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`)
...
INSERT INTO `contareceber` VALUES (1,1,'2024-05-15',100.00,'1'),(2,2,'2024-05-20',150.00,'3'),(3,3,'2024-05-10',200.00,'1');
...
-- Dump completed on 2024-05-04 22:34:47
